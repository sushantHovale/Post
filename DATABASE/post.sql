...
(11, 'sushant', 'hovale', 'sushanthovale94@gmail.com', 'fdbcc4ec83753301dffdcb5dff4bdeec7cfe3cb8', 'freshBigBites'),
(12, 'sushant', 'hovale', 'sushanthovale@gmail.com', 'fdbcc4ec83753301dffdcb5dff4bdeec7cfe3cb8', 'sushant'),
(13, 'sushant', 'hovale', 'sushantshovale@gmail.com', 'fdbcc4ec83753301dffdcb5dff4bdeec7cfe3cb8', 'sushanth');
...
CREATE TABLE IF NOT EXISTS `userad` (
  ...
  `person_avl` varchar(50) NOT NULL,
...
INSERT INTO `userad` (`id`, `cat_id`, `ad_title`, `photo_name`, `description`, `price`, `contact_name`, `email`, `m_number`, `address`, `u_name`, `food`, `person`, `person_avl`) VALUES
...
(14, 59, 'Want to share house', 'Screenshot (29).png', ' ', 2000, 'sushant', 'sushanthovale94@gmail.com', '7411067229', 'cbt, Dakkapa Circle', 'freshBigBites', '', '2', '1'),
(15, 58, 'Want to share house', 'Screenshot (5).png', ' ', 3000, 'sushant', 'sushanthovale94@gmail.com', '9988776655', 'cbt, Dakkapa Circle', 'freshBigBites', '', '4', '3'),
(16, 58, 'Want to share home', 'Screenshot (26).png', ' ', 1000, 'sushant', 'sushantshovale@gmail.com', '8899779966', 'cbt', 'freshBigBites', 'yes', '3', '3');

-- --------------------------------------------------------

--
-- Table structure for table `useradbook`
--

DROP TABLE IF EXISTS `useradbook`;
CREATE TABLE IF NOT EXISTS `useradbook` (
...
--
-- Dumping data for table `useradbook`
--

INSERT INTO `useradbook` (`book_id`, `id`, `f_name`, `l_name`, `u_email`, `mobile`, `uid`, `person`) VALUES
(1, '16', 'sushant', 'hovale', 'sushanthovale94@gmail.com', '7411067229', '12345', '1'),
(2, '16', 'sushant', 'hovale', 'sushanthovale94@gmail.com', '7411067229', '12345', '1'),
(3, '15', 'sushant', 'hovale', 'sushanthovale94@gmail.com', '7411067229', '12345', '1');
