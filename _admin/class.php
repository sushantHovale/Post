...
$query="Select * from sub_heading where sub_id='4' order by position asc";
...
<div id="page">         
   	  ...
   	  <div id="table">   
		<form id="form" name="form" method="post" action="classinsert.php">
        	...
        	<table>
            	...
            	<tr>
                	<td colspan="2" id="tableh2"><b>Add new subcategory,to 'class' heading</b></td>
            	</tr>
                <tr>
