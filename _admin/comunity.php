...
$query="Select * from sub_heading where sub_id='2' order by position asc";
...
<div id="page">         
   	  ...
   	  <div id="table">   
		<form id="form" name="form" method="post" action="cominsert.php">
        	...
        	<table>
            	...
            	<tr>
                	<td colspan="2" id="tableh2"><b>Add new subcategory, comunity heading</b></td>
            	</tr>
                <tr>
