...
if(isset($_REQUEST['EDITC']) && $_REQUEST['EDITC']!='')
{
	...
	$query="Select * from heading WHERE id='$editid'";
...
<img src="../_images/signin.png" />
   	  ...
   	  <div id="table">   
		<form id="form" name="form" method="post" action="editmenupros.php">
        	...
        	<table>
            	...
            	<tr>
                    ...
                    <td width="238"><input name="rr_title" type="text" class="inputfield" id="rr_title" disabled="disabled"  placeholder="<?php echo $fetch['title'];?>"/></td>
                    
            	</tr>
                <tr>
                	<td width="200" class="text">Enter new name</td>
                    <td width="238"><input name="fr_title" type="text" class="inputfield" id="fr_title" placeholder="........." /></td>
                    
            	</tr>
                <tr>
                	<td width="200" class="text">Old extension name</td>
                    <td width="238"><input name="rr_title" type="text" class="inputfield" id="rr_title" disabled="disabled"  placeholder="<?php echo $fetch['extension'];?>"/></td>
                    
            	</tr>
                <tr>
                	<td width="200" class="text">Enter new extension</td>
                    <td width="238"><input name="ext" type="text" class="inputfield" id="ext" placeholder="........." /></td>
