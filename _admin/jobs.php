...
$query="Select * from sub_heading where sub_id='3' order by position asc";
...
<div id="page">         
   	  ...
   	  <div id="table">   
		<form id="form" name="form" method="post" action="jobsinsert.php">
        	...
        	<table>
            	...
            	<tr>
                	<td colspan="2" id="tableh2"><b>Add new subcategory, jobs heading</b></td>
            	</tr>
                <tr>
