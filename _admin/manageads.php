...
<div id="topmenu">
<a href="manageuserads.php">Users posts</a>
</div> 
...
$k=1;
 while($rec=mysql_fetch_array($insertionquery)){?>   	   
        	<table cellspacing="0" cellpadding="0" id="table">
            	...
            	<tr>
                	<td colspan="2" id="tableh2"><b>Free post</b></td>
            	</tr>
  ...
  <tr>
    ...
    <td style="width:70px;"><a href="delpost.php?DELC=<?php echo $rec['id']?>"><img src="../_images/delet.png"/></a></td>
