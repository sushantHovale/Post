...
$query="Select * from sub_heading where sub_id='5' order by position asc";
...
<div id="page">         
   	  ...
   	  <div id="table">   
		<form id="form" name="form" method="post" action="resinsert.php">
        	...
        	<table>
            	...
            	<tr>
                	<td colspan="2" id="tableh2"><b>Add new subcategory, to real estate heading</b></td>
            	</tr>
                <tr>
