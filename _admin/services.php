...
$query="Select * from sub_heading where sub_id='6' order by position asc";
...
<div id="page">        
   	  ...
   	  <div id="table">   
		<form id="form" name="form" method="post" action="serinsert.php">
        	...
        	<table>
            	...
            	<tr>
                	<td colspan="2" id="tableh2"><b>Add new subcategory, Services heading</b></td>
            	</tr>
                <tr>
            	...
            	<tr>
                  ...
                  <input name="seret" type="seret" class="inputbutton" id="button" value="Reset All" /></td>
            	</tr>
            </table>     
        </form>
  ...
  <tr class="id1">
    ...
    <td><a href="editser.php?EDITC=<?php echo $get['id']?>"><img src="../_images/edit.png" /></a></td>
    <td><a href="deser.php?DELC=<?php echo $get['id']?>"><img src="../_images/delet.png" /></a></td>
  </tr>
  <?php $k++; }?>
          </table>
